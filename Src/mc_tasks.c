 ...
 * @param vMecSpeedUnit the stator voltage speed, expressed in the unit defined by #SPEED_UNIT
 * @param amp
 * @param Valphabeta
 * @retval void
 */
 ...
 * V_alpha = V * cos(phase);
 * V_beta = V * sin(phase);
 * @param amp amplitute the voltage
 * @param theta phase of the voltage.
