...
#define RS                     0.59 /* Stator resistance , ohm*/
#define LS                     0.00087 /* Stator inductance, H
...
#define NOMINAL_CURRENT         5144
#define MOTOR_MAX_SPEED_RPM     5280 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  3.6 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -5144 /*!< Demagnetization current */
...
#define HALL_PHASE_SHIFT        117 /*!< Define here in degrees
